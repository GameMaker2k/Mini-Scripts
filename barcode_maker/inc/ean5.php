...
function create_ean5($upc, $offsetadd, $imgres)
{
    ...
    while ($NumZero < count($LeftDigit)) {
        ...
        if ($CheckSum == 0 && $NumZero == 2) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 0 && $NumZero == 3) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 0 && $NumZero == 4) {
            $left_text_color = $left_text_color_l;
        }
        ...
        if ($CheckSum == 1 && $NumZero == 2) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 1 && $NumZero == 3) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 1 && $NumZero == 4) {
            $left_text_color = $left_text_color_l;
        }
        ...
        if ($CheckSum == 2 && $NumZero == 2) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 2 && $NumZero == 3) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 2 && $NumZero == 4) {
            $left_text_color = $left_text_color_l;
        }
        ...
        if ($CheckSum == 3 && $NumZero == 2) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 3 && $NumZero == 3) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 3 && $NumZero == 4) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 4 && $NumZero == 0) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 4 && $NumZero == 1) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 4 && $NumZero == 2) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 4 && $NumZero == 3) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 4 && $NumZero == 4) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 5 && $NumZero == 0) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 5 && $NumZero == 1) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 5 && $NumZero == 2) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 5 && $NumZero == 3) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 5 && $NumZero == 4) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 6 && $NumZero == 0) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 6 && $NumZero == 1) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 6 && $NumZero == 2) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 6 && $NumZero == 3) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 6 && $NumZero == 4) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 7 && $NumZero == 0) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 7 && $NumZero == 1) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 7 && $NumZero == 2) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 7 && $NumZero == 3) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 7 && $NumZero == 4) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 8 && $NumZero == 0) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 8 && $NumZero == 1) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 8 && $NumZero == 2) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 8 && $NumZero == 3) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 8 && $NumZero == 4) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 9 && $NumZero == 0) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 9 && $NumZero == 1) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 9 && $NumZero == 2) {
            $left_text_color = $left_text_color_g;
        }
        if ($CheckSum == 9 && $NumZero == 3) {
            $left_text_color = $left_text_color_l;
        }
        if ($CheckSum == 9 && $NumZero == 4) {
            $left_text_color = $left_text_color_g;
        }
        $InnerUPCNum = 0;
