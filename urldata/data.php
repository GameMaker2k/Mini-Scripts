...
if(!isset($_GET['data'])&&isset($_POST['data'])) { $_GET['data'] = $_POST['data']; }
if(isset($_GET['data'])&&($_GET['data']===null||$_GET['data']=="")) { unset($_GET['data']); }
...
<?php unset($_GET['data']); } if(isset($_GET['data'])) { 
