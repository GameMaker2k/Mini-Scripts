...
/*
    ...
    $FileInfo: test.php - Last Update: 8/22/2009 Version 8 - Author: cooldude2k $
*/
@ob_clean(); @ini_set('default_charset', 'iso-8859-15');
...
<?php
$en_ru = array("A=&#".hexdec("0410").";","a=&#".hexdec("0430").";",
